...

{
    ...
    "class_url": "https://auete.com/{cateId}/index{catePg}.html[firstPage=https://auete.com/{cateId}/index.html]",
    //分类名，分类1&分类2&分类3
    "class_name": "电影&电视剧&综艺&动漫&其它&音乐Mv&喜剧片&动作片&爱情片&科幻片&恐怖片&战争片&剧情片&美剧&韩剧&日剧&泰剧&网剧&台剧&国产&港剧&英剧",
    //分类名替换词，替换词1&替换词2&替换词3，替换词包含英文&的用两个中文＆＆代替，示例：＆＆id=0&＆＆id=1
    "class_value": "Movie&Tv&Zy&Dm&qita&Music&Movie/xjp&Movie/dzp&Movie/aqp&Movie/khp&Movie/kbp&Movie/zzp&Movie/jqp&Tv/oumei&Tv/hanju&Tv/riju&Tv/yataiju&Tv/wangju&Tv/taiju&Tv/neidi&Tv/tvbgj&Tv/yingju",
    //筛选数据，json格式，参考xpath的筛选写法
    "filterdata":{},
    //分类是否二次截取
    "cat_YN_twice": "1",
    //分类二次截取前
    "cat_twice_pre": "class=\"threadlist",
    //分类二次截取后
    "cat_twice_suf": "</ul>",
    ...
    "sea_YN_twice": "1",
    //搜索二次截取前
    "sea_twice_pre": "class=\"list-unstyled",
    //搜索二次截取后
    "sea_twice_suf": "</ul>",
    ...
    "sea_pic": "date&&text",
    //搜索片单标题，截取前缀&&截取后缀
    "sea_title": "break-all\">&&</a>",
    //搜索片单链接，截取前缀&&截取后缀
    "sea_url": "href=\"&&\"",
    //搜索片单链接补前缀
    "search_prefix": "https://auete.com",
    ...
    //线路截取数组前
    "tab_arr_pre": "id=\"player_list",
    //线路截取数组后
    "tab_arr_suf": "</h2>",
    //线路标题，截取前缀&&截取后缀
    "tab_title": "class=\"icon-film\">&&<small",
